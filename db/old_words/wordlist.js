...
words[5] = new Array();
words[5][0] = "SYMPOSIUM";
words[5][1] = "+A formal meeting at which speakers present ideas or opinions about a particular+topic and have discussions about it.";
...
words[1][2] = "The smell of the+fresh bread was EVOCATIVE of his early years working at+the local+bakery."
...
words[3][2] = "The judge had to INVOKE the principles stated in the Bill of Rights as the basis for+making his ruling."
...
words[6][2] = "The police had to REVOKE his license because+he had too+many speeding tickets."
...
words[8][2] = "The decision to invade Iraq was not meant to PROVOKE the American public in the way that+resulted.+"
...
words[0][2] = "We had a slight+DEVIATION in our plans to attend our friend's graduation party.+ Instead of going to his house directly after the ceremony, we went to visit our parents and then went onto+his party. "
...
words[2][2] = "Plastic is an IMPERVIOUS material, water will not pass through it.+ Sometimes I think my sister is impervious to criticism, she just does not+believe she+has any+flaws."
...
words[4][2] = "Some of my friends know lots of TRIVIA and so+they can+talk about any topic, especially the television+game show, Jeopardy."
...
words[6][3] = "through, by+way of, by means of "
words[6][4] = "+"
words[6][5] = "+"
words[6][6] = "+"
words[6][7] = "+"
...
words[8][2] = "The word PREVIOUS occurs only before a noun.+ For example, I spoke with the previous owner about my+previous business, but I needed the previous information, etc. "
...
words[9][2] = "The Romans were the first+pople to+use a+VIADUCT system within their cities to carry one road over another.++ Now many highways have viaducts that carry one road over another at specific interchanges.+"
...
words[2][2] = "The+barricade was+put up+to DIVERT the flow of water+and move it around+the homes that were built along the river."
...
words[7] = new Array();
words[7][0] = 'OBVERSE';
words[7][1] = "the opposite of a particular situation or feeling, or+the other side of something like a coin"
...
words[9][2] = "An introvert is a kind of person who+prefers to spend+much time alone, while an EXTROVERT is someone just the opposite, outgoing, friendly, and fun to be with.+"
...
words[0][2] = "The Iroquois are a+TRIBE of Indians that live in the Upstate New York area, not far from Rochester."
words[0][3] = "clan"
words[0][4] = "+"
words[0][5] = "+"
words[0][6] = "+"
...
words[3][2] = "My mother took the roasted chicken out of the oven and put the pan on a+TRIVET so it would not burn her table."
...
words[9][2] = "John+had worked at his job over thirty years so he was a VERITABLE storehouse of information about the history of the company."
...
words[2][2] = "The CONTORTIONIST went through+a series of amazing body positions that I could never have imagined or even attempt to do.";
words[2][3] = "acrobat,";
words[2][4] = "";
...
words[1] = new Array();
words[1][0] = 'SYMPOSIUM';
words[1][1] = "+A formal meeting at which speakers present ideas or opinions about a particular+topic and have discussions about it."
...
words[3][2] = "The team members had a SYNERGISTIC relationship, so+when John+created a+new+idea, Patty and Dave came up with effective ideas also."
...
words[4][2] = "I knew+the play was over three hours long, so I read a SYNOPSIS of it that was less than 500 words long."
...
words[7][2] = "New York City has the most+beautiful SYNAGOGUE in the country.+ Many people worship there during Passover and other holidays."
words[7][3] = "temple"
words[7][4] = "+"
words[7][5] = "+"
words[7][6] = "+"
...
words[9] = new Array();
words[9][0] = 'OBSESSION';
words[9][1] = "an unreasonable strong continuous interest in something, a persistent desire that will+not stop or go away"
words[9][2] = "Tom was sure his girlfriend was lying to him and his+OBSESSiON with proving her a liar almost destroyed him. He just could not stop thinking about+what to do about her lies."
...
words[7][2] = "John added+his POSTSCRIPT, after he had signed his letter to his boss about quitting his job, to explain one more reason for his actions."
words[7][3] = "afterword"
words[7][4] = "+"
words[7][5] = "+"
words[7][6] = "+"
...
words[3][2] = "Because he had been+unemployed himself for almost+a year,+he now felt EMPATHY for his recently unemployed friend."
...
words[4][2] = "It is most EXPEDIENT to begin writing your long term paper+a few weeks+before it is due."
...
words[0][2] = "The AMORPHOUS pile of concrete and steel had to be removed as soon as possible after+the Twin Towers in New York City collapsed on 9/11, 2001."
...
words[3][2] = "Following surgery, MORPHINE is often prescribed by doctors+to alleviate+the pain patients may experience."
...
words[8] = new Array();
words[8][0] = 'PANTHEON';
words[8][1] = "the name for the historical building built in Rome as a place to worship+all of the gods during Roman times.+ The building still stands today."
...
words[10][2] = "Because he frequently+said he was+sick just before he had to go to work, his boss thought he was MALINGERING when he called in sick twice a week."
...
words[3] = new Array();
words[3][0] = 'PANDEMIC';
words[3][1] = "an+occurrence, especially of a+disease, prevalent among the people throughout an entire country, or continent, or even the whole world"
words[3][2] = "The+Bubonic plague,+also called the Black Death,+was PANDEMIC throughout all of the Europe during the 19th century."
...
words[9][1] = "a+Christian type of+prayer said as a blessing "
...
words[1][2] = "As I walked into the main+CONCOURSE of Chicago's O'Hare Airport, I saw a large statue in the middle of a fountain right next to the main food court."
...
words[5][2] = "The old fashioned typewriter was a PRECURSOR to modern+word processing+in the same way that the TTY for the+Deaf+was a+early version of+modern text messaging."
...
words[1][2] = "The gas mileage+in my new car+is supposed to exceed the mileage I now get with my old car."
...
words[5][2] = "The flood waters in New Orleans+began to recede after a few days of sunshine and dry weather."
...
words[6][2] = "The New York State Government had to retrocede the+land+around Sherrill, NY to the Native Indian tribe that lives there."
words[6][3] = "return"
words[6][4] = "+"
...
words[1][1] = "to realize beforehand, to expect+something will happen and be ready for it+"
words[1][2] = "We did not ANTICIPATE the+results of next week's football game."
...
words[6][1] = "Being charitable by+giving money to benefit others"
...
words[11][2] = "The original RIT campus buildings, some established in 1829+in downtown Rochester, ANTEDATE the newer campus buildings built in 1966."
...
words[1][2] = "The earliest Greek tragedies+were performed in open amphitheaters under the stars in the cool evenings of summer."
words[1][3] = "theatre"
words[1][4] = "+"
...
words[2][2] = "Ukraine accepted Christian faith+in 988 A.D., and celebrated its MILLENNIUM of Christianity in 1988."
...
words[3][2] = "There are PERENNIAL flowers+planted in our front garden, such as roses and daffodils, that look better each year."
...
words[5][2] = "The English Writing Lab was full of SUPERANNUATED computers+at the beginning of the+year, but finally upgraded to the new computers this past summer."
...
words[6][2] = "The original RIT campus buildings, some established in 1829+in downtown Rochester, ANTEDATE the newer campus buildings built in 1966."
...
words[8][2] = "When John went to the dentist to have a filling put in his tooth, the dentist gave him an anesthetic to numb the gum+so the tooth could be drilled without pain. "
words[8][3] = "novocaine"
words[8][4] = "+"
...
words[2][3] = "two-handed, skilled equally with+either hand"
words[2][4] = "+"
...
words[4][2] = "The earliest Greek tragedies+were performed in open amphitheaters under the stars in the cool evenings of summer."
words[4][3] = "theatre"
words[4][4] = "+"
...
words[7][2] = "Ambulate and perambulate roughly express the same+idea of walking about without any hurry."
...
words[11][1] = "An animal that can live in the water and on the land, for example, frogs, salamanders, caecilians: also a small+airplane that can land or take off on the water, or a flat-bottomed military vehicle that has tracks for land travel and a rudder for travel in the water."
...
words[14][2] = "When John went to the dentist to have a filling put in his tooth, the dentist gave him an anesthetic to numb the gum+so the tooth could be drilled without pain.";
...
words[15][2] = "After working in the same job for many years, she became APATHETIC, and no longer+tried to do+her best.";
